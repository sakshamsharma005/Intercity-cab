    ...
    <main>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:py-24">
        <div className="flex items-end justify-between flex-wrap gap-4 mb-10">
          ...
          <Link to="/find-rides" className="text-sm font-semibold text-primary inline-flex items-center gap-1 hover:gap-2 transition-all">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {POPULAR_ROUTES.map((r) => (
            <Link
              key={`${r.from}-${r.to}`}
              to={`/find-rides?from=${encodeURIComponent(r.from)}&to=${encodeURIComponent(r.to)}&seats=1`}
